...
urlpatterns = [
	...
	path('solicitud/reinscripcion/firmas/pendiente', views_f.reinscripcion_firmas_pendiente,name='reinscripcion_firmas_pendiente'),
    ...
    path('success/',views_f.success,name='success'),
